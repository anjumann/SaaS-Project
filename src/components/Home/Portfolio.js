  ...
  const serviceList = [
    {
      ...
      "description": "Unlock your online potential with captivating websites.",
      "features": ["Engaging", "Responsive", "SEO Optimized", "User-friendly", "Scalable"],
      "image": "website-development.jpg"
    },
    {
      "title": "Mobile App Development",
      "description": "Embrace the power of mobile with cutting-edge apps.",
      "features": ["Sleek UI", "Intuitive", "High Performance", "Cross-platform", "Engaging"],
      "image": "mobile-app-development.jpg"
    },
    {
      "title": "Software Development",
      "description": "Unleash your business's full potential with tailor-made software.",
